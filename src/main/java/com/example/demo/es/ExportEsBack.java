...
@RestController
@Api(tags = "导出备份")
@RequestMapping("/esExportBack")
public class ExportEsBack {

    private String writeFilePath;
  //  private String url = "E:/database/quanguo";
    ...
    public String export(@RequestBody ExportEsRequest exportEsRequest) throws Exception {
        try {
                ...
                mapl.put("keytype", "17");
                mapl.put("insertStartTime", exportEsRequest.getStartTime());
                mapl.put("insertEndTime", exportEsRequest.getEndTime());
                ...
                for (int aa=0 ; aa <listl.size(); aa++) {
                    ...
                    map.put("insertStartTime", exportEsRequest.getStartTime());
                     map.put("insertEndTime",exportEsRequest.getEndTime());
                     if(StringUtils.isNotBlank(exportEsRequest.getSourceTypes()))
