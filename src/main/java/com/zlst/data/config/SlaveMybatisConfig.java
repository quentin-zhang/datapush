 ...
 **/
@Configuration
@MapperScan(value={"com.zlst.data.mapper.slave*"},sqlSessionFactoryRef = "slaveSqlSessionFactory")
public class SlaveMybatisConfig {
    ...
    public SqlSessionFactory slaveSqlSessionFactory(@Qualifier("slave") DataSource dataSource) throws Exception {
        ...
        String locationPattern = "classpath*:com/zlst/data/mapper/slave/*.xml";
        mybatisSqlSessionFactoryBean.setMapperLocations(resolver.getResources(locationPattern));
        //对应数据库的entity位置
        String typeAliasesPackage = "com.zlst.data.pojo.slave";
